...
public class WXerweimaFragment extends HeaderFragment {
	...
	public void onCreate(@Nullable Bundle savedInstanceState) {
		...
		PrefsUtils.savePrefString(getActivity(), lsh + "d", danNo);
		ysje02 = PrefsUtils.loadPrefString(getActivity(), lsh + "w");
		
		if ((null != ysje02 && !ysje02.equals(ysje)) || null == PrefsUtils.loadPrefString(getActivity(), lsh + "c") || PrefsUtils.loadPrefString(getActivity(), lsh + "c").equals("")) {
			...
			public void onResult(ResultData arg0) {
				...
				if (arg0.busicd.equals("INQY")) {
					...
					if (arg0.respcd.equals("00") || arg0.respcd == "00") {
						...
						PrefsUtils.clearPreByKey(getActivity(), lsh + "d");
					}
				}
