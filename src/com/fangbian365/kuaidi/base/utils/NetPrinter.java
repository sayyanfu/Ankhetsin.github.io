...
public class NetPrinter {
	...
	public void PrintText(String pszString, int nFontAlign, int nFontSize,
			int ifzhenda) {
		try {
			OutputStream stream = socket.getOutputStream();
	...
	// / <param name="fontsize">字体大小0:正常大小 1:两倍高 2:两倍宽 3:两倍大小 4:三倍高 5:三倍宽 6:三倍大小
	// 7:四倍高 8:四倍宽 9:四倍大小 10:五倍高 11:五倍宽 12:五倍大小</param>
	public void PrintTiaoMa(String numstr, int height, int width, int numweizi,
			int fontalign, int fontsize) {
		try {
			OutputStream stream = socket.getOutputStream();
...
class PrinterCMD {
	...
	public String CMD_SetPos() {
		return new StringBuffer().append((char) 27).append((char) 64)
				.toString();
	}
	...
	public String CMD_TextAlign(int align) {
		return new StringBuffer().append((char) 27).append((char) 97)
				.append((char) align).toString();
	}
	...
	public String CMD_FontSize_BTP_M2801(int size) {
		...
		switch (fontsize) {
		case 1:
			_cmdstr = new StringBuffer().append((char) 27).append((char) 33)
					.append((char) 17).toString();
			break;
		case 2:
			_cmdstr = new StringBuffer().append((char) 27).append((char) 33)
					.append((char) 33).toString();
			break;
		case 3:
			_cmdstr = new StringBuffer().append((char) 27).append((char) 33)
					.append((char) 49).toString();
			break;
		default:
			_cmdstr = new StringBuffer().append((char) 27).append((char) 33)
					.append((char) 1).toString();
	...
	public String CMD_PageGO(int line) {
		return new StringBuffer().append((char) 27).append((char) 100)
				.append((char) line).toString();
	}
	...
	public String CMD_CutPage() {
		return new StringBuffer().append((char) 27).append((char) 109)
				.toString();
	}
	...
	public String CMD_ReturnStatus(int num) {
		return new StringBuffer().append((char) 16).append((char) 4)
				.append((char) num).toString();
	}
	...
	public String CMD_TiaoMaHeight(int num) {
		...
		return new StringBuffer().append((char) 29).append((char) 104)
				.append((char) num).toString();
	}
	...
	public String CMD_TiaoMaWidth(int num) {
		...
		return new StringBuffer().append((char) 29).append((char) 119)
				.append((char) num).toString();
	}
	...
	public String CMD_TiaoMaWeiZi(int num) {
		return new StringBuffer().append((char) 29).append("H")
				.append((char) num).toString();
	}
	...
	public String CMD_TiaoMaPrint(String numstr) {
		// return ((char)29).append"k" + ((char)4).appendnumstr +
		// ((char)0).toString();
		return new StringBuffer().append((char) 29).append((char) 107)
				.append((char) 4).append(numstr).append((char) 0).toString();
	}
	...
	public String CMC_QianXiang() {
		return new StringBuffer().append((char) 27).append((char) 112)
				.append((char) 0).append((char) 60).append((char) 255)
				.toString();
	}
}