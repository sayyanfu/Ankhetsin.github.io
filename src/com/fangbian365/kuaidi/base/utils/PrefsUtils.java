...
public class PrefsUtils {
	...
	private static final String PREFS = "chihuobao_prefs";
	 ...
	 * @return
	 */
	public static boolean usePrefBoolean(Context context, String key,
			boolean defaultValue) {
		if (pref == null) {
			pref = PreferenceManager.getDefaultSharedPreferences(context);
		}
	...
	public static void clearPreByKey(Context context, String key) {
		if (pref == null) {
			pref = context.getSharedPreferences(PREFS, Context.MODE_PRIVATE);
			//pref = PreferenceManager.getDefaultSharedPreferences(context);
		}
